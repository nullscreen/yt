...
module Yt
  module Models
    ...
    class Request
      ...
      # Returns the +cURL+ version of the request, useful to re-run the
      # request in a shell terminal.
    ...
    private
      ...
      # if the request body is a JSON Object, transform its keys into camel-
      # case, since this is the common format for JSON APIs.
